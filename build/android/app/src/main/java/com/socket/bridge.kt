  ...
  fun route (
      ...
      if (message.has("path")) {
        ...
        if (!isAssetBundleUri(uri)) {
          ...
          try {
            ...
            message.set("path", "socket://com.socket/$path")
            stream.close()
    ...
    when (message.command) {
      ...
      "os.paths" -> {
        ...
        val resources = "socket://com.socket"
      ...
      "notification.show" -> {
        ...
        val channel = message.get("channel", "default").replace("default", "com.socket");
        ...
        if (message.has("icon")) {
          val url = message.get("icon")
            .replace("socket://com.socket", "https://appassets.androidplatform.net/assets")
            .replace("https://com.socket", "https://appassets.androidplatform.net/assets")
